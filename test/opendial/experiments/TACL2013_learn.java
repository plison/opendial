...
//	public static final String suffix = "structured";
	...
	public static void main(String[] args) {
		try {
			...
			WoZQuerySampling.FACTOR = (args.length > 4)? Double.parseDouble(args[4]) : WoZQuerySampling.FACTOR;
			...
			EqualityDistribution.PROB_WITH_DOUBLE_NONE = (args.length > 8)? Double.parseDouble (args[8]) : EqualityDistribution.PROB_WITH_DOUBLE_NONE;
