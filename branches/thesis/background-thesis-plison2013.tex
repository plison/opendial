...
In his seminal work in the philosophy of language, \cite{searle1975taxonomy} established a taxonomy of speech acts\index{speech act} divided in five central categories:
\begin{description}
...
\item And finally, \textit{speech synthesis}, in charge of synthesizing an audio signal out of the generated utterance.
 \end{enumerate}
 \index{speech recognition}\index{dialogue understanding}\index{dialogue management}\index{natural language generation}\index{speech synthesis}
...
\index{frame-based dialogue management}
