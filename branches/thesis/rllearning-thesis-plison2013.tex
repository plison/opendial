...
As argued in the next section, probabilistic rules\index{probabilistic rule} can contribute to addressing by reducing the number of parameters and filtering out irrelevant actions from the planning process.
...
The transition model\index{transition model} for our human--robot interaction dialogue domain is factored in four components:
\begin{enumerate}
