...
We now assume the effect distribution associated with the predictive rule $r_{11}$ to be initially unknown and replaced by parameters, leading to the following rule:
\begin{align*}
r_{11}: \ \ & \forall y, \\ 
