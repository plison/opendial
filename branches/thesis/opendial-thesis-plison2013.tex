...
\begin{figure}[ht] \vspace{6mm}
\centering
\includegraphics[scale=0.30]{imgs/impl_architecture.pdf} \vspace{4mm}
\caption{Generic system architecture employed in the experiments. The dialogue state serves as a central hub for the various modules reading and writing to it upon relevant changes. }
