...
The conditional probability distribution of a rule node $r$ given its input variables $I_1, \dots, I_k$ and parameters $\boldsymbol\theta_{r(1, \cdot)}, \dots, \boldsymbol\theta_{r(n, \cdot)}$ is a straightforward adaptation of Equation \eqref{eq:ruledistrib}:
\begin{align}
