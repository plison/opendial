...
& = U_i(A_1\!=\!a_1, \dots, A_l\!=\!a_l\,; \boldsymbol\theta_{r(i, \cdot)})  \label{eq:utildistrib}\\
& \; \; \; \; \; \; \; \; \text{ where } i = \min_i (c_i \text{ is satisfied with } I_1\!=\!i_1 \land \dots \land I_k\!=\!i_k) \nonumber
\end{align}
