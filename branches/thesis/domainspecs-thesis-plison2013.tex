...
$r_{2}$: \ \ & $ \textbf{if} \ (\mathit{completed\mbox{-}task}\!=\!\mathit{false}) \ \textbf{then} $ \\
 & \;\;\;\;\; $ \begin{cases}P(\mathit{i_u}\!=\!\mathit{{i_u}})\!=\!1 \end{cases}$ \\ \\[-1mm]
...
P(\mathit{i_u}\!=\!\mathit{DoYouSee(object_1)})\!=\!\theta_{\mathrm{moveprior[4]}} \\
P(\mathit{i_u}\!=\!\mathit{DoYouSee(object_2)})\!=\!\theta_{\mathrm{moveprior[5]}} \\
P(\mathit{i_u}\!=\!\mathit{WhatDoYouSee})\!=\!\theta_{\mathrm{moveprior[6]}} \\
P(\cdot)\!=\!\theta_{\mathrm{moveprior[7]}} \end{cases}$ \\ \\[-1mm]
$r_{4}$: \ \ & $\forall \ O: $ \\ & $ \textbf{if} \ (\mathit{completed\mbox{-}task}\!=\!\mathit{true} \land \mathit{O}\!\in\!\mathit{carried}) \ \textbf{then} $ \\
 & \;\;\;\;\; $ \begin{cases}P(\mathit{i_u}\!=\!\mathit{Release(O)})\!=\!\theta_{\mathrm{releaseprior[0]}} \\
P(\cdot)\!=\!\theta_{\mathrm{releaseprior[1]}} \end{cases}$ \vspace{1mm} \\ & $ \textbf{else if} \ (\mathit{completed\mbox{-}task}\!=\!\mathit{true}) \ \textbf{then}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{i_u}\!=\!\mathit{Release(O)})\!=\!\theta_{\mathrm{releaseprior2[0]}} \\
...
$r_{5}$: \ \ & $\forall \ O: $ \\ & $ \textbf{if} \ (\mathit{completed\mbox{-}task}\!=\!\mathit{true} \land \mathit{carried}\!=\!\mathit{[]}) \ \textbf{then} $ \\
 & \;\;\;\;\; $ \begin{cases}P(\mathit{i_u}\!=\!\mathit{PickUp(O)})\!=\!\theta_{\mathrm{pickupprior[0]}} \\
P(\cdot)\!=\!\theta_{\mathrm{pickupprior[1]}} \end{cases}$\vspace{1mm} \\ & $ \textbf{else if} \ (\mathit{completed\mbox{-}task}\!=\!\mathit{true}) \ \textbf{then}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{i_u}\!=\!\mathit{PickUp(O)})\!=\!\theta_{\mathrm{pickupprior2[0]}} \\
...
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{groundpredict[1]}} \\
...
P(\mathit{a_u^p}\!=\!\mathit{Ask({i_u})})\!=\!\theta_{\mathrm{groundpredict2[1]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{groundpredict2[2]}} \\
P(\cdot)\!=\!\theta_{\mathrm{groundpredict2[3]}} \end{cases}$  \vspace{1mm} \\ & $ \textbf{else if} \ (\mathit{a_m}\!=\!\mathit{Confirm({X})} \land \mathit{i_u}\!=\!\mathit{{X}}) \ \textbf{then}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{a_u^p}\!=\!\mathit{Confirm})\!=\!\theta_{\mathrm{confirmpredict[0]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Ask({i_u})})\!=\!\theta_{\mathrm{confirmpredict[1]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{confirmpredict[2]}} \\
P(\cdot)\!=\!\theta_{\mathrm{confirmpredict[3]}} \end{cases}$\vspace{1mm} \\ & $ \textbf{else if} \ (\mathit{a_m}\!=\!\mathit{Confirm({X})} \land \mathit{i_u}\!\neq\!\mathit{{X}} \land \mathit{i_u}\!\neq\!\mathit{None}) \ \textbf{then}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{a_u^p}\!=\!\mathit{Disconfirm})\!=\!\theta_{\mathrm{disconfirmpredict[0]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{disconfirmpredict[1]}} \\
...
P(\mathit{a_u^p}\!=\!\mathit{Ask({i_u})})\!=\!\theta_{\mathrm{samemove[1]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{samemove[2]}} \\
...
& \;\;\;\;\; $ \begin{cases}P(\mathit{a_u^p}\!=\!\mathit{Ask({i_u})})\!=\!\theta_{\mathrm{intent[0]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{intent[1]}} \\
P(\cdot)\!=\!\theta_{\mathrm{intent[2]}} \end{cases}$  \vspace{1mm} \\ & $ \textbf{else if} \ (\mathit{i_u}\!=\!\mathit{None}) \ \textbf{then}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!1.0 \end{cases}$ \vspace{1mm} \\ & $ \textbf{else}$ \\
& \;\;\;\;\; $ \begin{cases}P(\mathit{a_u^p}\!=\!\mathit{Ask({i_u})})\!=\!\theta_{\mathrm{othercase[0]}} \\
P(\mathit{a_u^p}\!=\!\mathit{Nothing})\!=\!\theta_{\mathrm{othercase[1]}} \\
