...
Based on Equation \ref{eq:bl}, the posterior distribution $P(\boldsymbol\theta  \, | \, \mathcal{D})$ can be calculated with standard inference algorithms for graphical models. 
