...
public class TemplateString {
	...
	public TemplateString fillSlotsPartial(Assignment fillers) {
		...
		return new TemplateString(filledTemplate);
	}
	...
	public boolean equals(Object o) {
		if (o instanceof TemplateString) {
			if (((TemplateString)o).getRawString().equals(rawString) && 
					((TemplateString)o).getSlots().equals(slots.keySet())) {
				return true;
			}
		}
		return false;
