...
public class GraphViewer extends VisualizationViewer<String,Integer> implements AttachedModule  {
	 ...
	 */
	public GraphViewer(StateMonitorTab tab) {
	...
	/**
	 * Returns the Bayesian network currently displayed in the viewre
	 * 
	...
	/**
	 * Updates the graphical representation of the dialogue state
	 */
	@Override
	public void trigger(DialogueState state, String newNodeId) {
		showBayesianNetwork(currentState);
	}
